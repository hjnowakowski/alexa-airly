...
const messages = {
    ...
    GOODBYE: 'Bye! Thanks for using the Air Quality Skill!',
    UNHANDLED: 'This skill doesn\'t support that. Please ask something else.',
    HELP: 'You can use this skill to get weather quality information',
    STOP: 'Bye! Thanks for using the Air Quality Skill!',
};
